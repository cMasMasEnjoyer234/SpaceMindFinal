...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dtg_bd->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &Conceptos::dataGridView1_CellContentClick);
			...
			this->lbl_dia->Font = (gcnew System::Drawing::Font(L"JetBrains Mono NL SemiBold", 18, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Italic))));
			...
			this->lbl_dia->Size = System::Drawing::Size(98, 31);
			...
			this->lbl_fechatry->Font = (gcnew System::Drawing::Font(L"JetBrains Mono NL SemiBold", 16, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Italic))));
			...
			this->lbl_fechatry->Size = System::Drawing::Size(182, 29);
			...
			this->btn_verConcepto->Location = System::Drawing::Point(173, 415);
			...
			this->txt_idmostrar->TextChanged += gcnew System::EventHandler(this, &Conceptos::textBox1_TextChanged);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"JetBrains Mono NL SemiBold", 16, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Italic))));
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"JetBrains Mono NL SemiBold", 16, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Italic))));
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"JetBrains Mono NL SemiBold", 16, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Italic))));
			...
			this->Font = (gcnew System::Drawing::Font(L"JetBrains Mono NL SemiBold", 8.249999, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Italic)),
...
private: System::Void label3_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	private: System::Void btn_okborrar_Click(System::Object^ sender, System::EventArgs^ e) {
	}

	private: System::Void txtb_try1_TextChanged(System::Object^ sender, System::EventArgs^ e) {
	...
	public: void cargar_bd_repasar() {
		try {
			String^ connString = "dataSource=localhost; username=root; password=1234; database=spacemind";
			MySqlConnection^ sqlConn = gcnew MySqlConnection(connString);
			sqlConn->Open();

			String^ fecha_actual = day();

			String^ sqlQuery = "SELECT Id, Pregunta, Fecha_repaso, Nivel FROM Conceptos WHERE Fecha_repaso LIKE '"+ fecha_actual +"%' AND Nivel != '5'";
			MySqlCommand^ command = gcnew MySqlCommand(sqlQuery, sqlConn);
			MySqlDataReader^ reader = command->ExecuteReader();
	...
	String^ day()
	{
		...
		Int32 diA = timeInfo.tm_mday;
		Int32 mes = timeInfo.tm_mon + 1;
		Int32 año = timeInfo.tm_year + 1900;

		String^ Sdia = Convert::ToString(diA);
		String^ Smes = Convert::ToString(mes);
		String^ Saño = Convert::ToString(año);
		String^ todo = (Sdia + "/" + Smes + "/" + Saño);
		lbl_dia->Text = todo;
		return todo;
...
private: System::Void txt_idBorrar_TextChanged(System::Object^ sender, System::EventArgs^ e) {
}
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		if(User::limit_windows == true){
			User::limit_windows = false;
			prueba2::Agregar^ ver = gcnew prueba2::Agregar();
			ver->Visible = true;
		}
	}
